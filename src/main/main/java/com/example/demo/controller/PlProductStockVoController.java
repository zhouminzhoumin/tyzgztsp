...
*/
@RestController
@RequestMapping("/plproductstockvo/api")
@Api(value = "xx", description = "xx")
public class PlProductStockVoController {
 
    @Resource
    private PlProductStockVoService services;
    ...
    public List<PlProductStockVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlProductStockVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlProductStockVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlProductStockVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "PlProductStockVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody PlProductStockVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<PlProductStockVo>", required = true, dataType = "List<PlProductStockVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlProductStockVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlProductStockVo model) {
