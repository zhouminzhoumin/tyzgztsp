...
*/
@RestController
@RequestMapping("/plproductpicvo/api")
@Api(value = "xx", description = "xx")
public class PlProductPicVoController {
 
    @Resource
    private PlProductPicVoService services;
    ...
    public List<PlProductPicVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlProductPicVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlProductPicVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlProductPicVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "PlProductPicVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody PlProductPicVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<PlProductPicVo>", required = true, dataType = "List<PlProductPicVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlProductPicVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlProductPicVo model) {
