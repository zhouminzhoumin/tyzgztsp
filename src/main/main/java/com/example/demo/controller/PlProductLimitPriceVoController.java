...
*/
@RestController
@RequestMapping("/plproductlimitpricevo/api")
@Api(value = "xx", description = "xx")
public class PlProductLimitPriceVoController {
 
    @Resource
    private PlProductLimitPriceVoService services;
    ...
    public List<PlProductLimitPriceVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlProductLimitPriceVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlProductLimitPriceVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlProductLimitPriceVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "PlProductLimitPriceVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody PlProductLimitPriceVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<PlProductLimitPriceVo>", required = true, dataType = "List<PlProductLimitPriceVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlProductLimitPriceVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlProductLimitPriceVo model) {
