...
*/
@RestController
@RequestMapping("/plgiftinfovo/api")
@Api(value = "xx", description = "xx")
public class PlGiftInfoVoController {
 
    @Resource
    private PlGiftInfoVoService services;
    ...
    public List<PlGiftInfoVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlGiftInfoVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlGiftInfoVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlGiftInfoVo model = services.selectByPrimaryKey(id);
        return model;
        }
    ...
    @ResponseBody
    public Object add_one(@RequestBody PlGiftInfoVo model) {
    ...
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlGiftInfoVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlGiftInfoVo model) {
