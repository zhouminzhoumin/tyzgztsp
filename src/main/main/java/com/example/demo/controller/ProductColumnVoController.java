...
*/
@RestController
@RequestMapping("/productcolumnvo/api")
@Api(value = "xx", description = "xx")
public class ProductColumnVoController {
 
    @Resource
    private ProductColumnVoService services;
    ...
    public List<ProductColumnVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(ProductColumnVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<ProductColumnVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        ProductColumnVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "ProductColumnVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody ProductColumnVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<ProductColumnVo>", required = true, dataType = "List<ProductColumnVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<ProductColumnVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody ProductColumnVo model) {
