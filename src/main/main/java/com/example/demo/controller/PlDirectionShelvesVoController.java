...
*/
@RestController
@RequestMapping("/pldirectionshelvesvo/api")
@Api(value = "xx", description = "xx")
public class PlDirectionShelvesVoController {
 
    @Resource
    private PlDirectionShelvesVoService services;
    ...
    public List<PlDirectionShelvesVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlDirectionShelvesVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlDirectionShelvesVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlDirectionShelvesVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "PlDirectionShelvesVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody PlDirectionShelvesVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<PlDirectionShelvesVo>", required = true, dataType = "List<PlDirectionShelvesVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlDirectionShelvesVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlDirectionShelvesVo model) {
