...
*/
@RestController
@RequestMapping("/plproductcolumnvo/api")
@Api(value = "xx", description = "xx")
public class PlProductColumnVoController {
 
    @Resource
    private PlProductColumnVoService services;
    ...
    public List<PlProductColumnVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlProductColumnVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlProductColumnVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlProductColumnVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "PlProductColumnVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody PlProductColumnVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<PlProductColumnVo>", required = true, dataType = "List<PlProductColumnVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlProductColumnVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlProductColumnVo model) {
