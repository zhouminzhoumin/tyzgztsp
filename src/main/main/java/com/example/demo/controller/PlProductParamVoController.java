...
*/
@RestController
@RequestMapping("/plproductparamvo/api")
@Api(value = "xx", description = "xx")
public class PlProductParamVoController {
 
    @Resource
    private PlProductParamVoService services;
    ...
    public List<PlProductParamVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlProductParamVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlProductParamVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlProductParamVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "PlProductParamVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody PlProductParamVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<PlProductParamVo>", required = true, dataType = "List<PlProductParamVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlProductParamVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlProductParamVo model) {
