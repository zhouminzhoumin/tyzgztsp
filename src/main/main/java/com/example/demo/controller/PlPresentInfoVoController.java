...
*/
@RestController
@RequestMapping("/plpresentinfovo/api")
@Api(value = "xx", description = "xx")
public class PlPresentInfoVoController {
 
    @Resource
    private PlPresentInfoVoService services;
    ...
    public List<PlPresentInfoVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlPresentInfoVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlPresentInfoVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlPresentInfoVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "PlPresentInfoVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody PlPresentInfoVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<PlPresentInfoVo>", required = true, dataType = "List<PlPresentInfoVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlPresentInfoVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlPresentInfoVo model) {
