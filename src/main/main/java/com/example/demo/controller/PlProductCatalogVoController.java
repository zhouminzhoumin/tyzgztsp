...
*/
@RestController
@RequestMapping("/plproductcatalogvo/api")
@Api(value = "xx", description = "xx")
public class PlProductCatalogVoController {
 
    @Resource
    private PlProductCatalogVoService services;
    ...
    public List<PlProductCatalogVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlProductCatalogVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlProductCatalogVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlProductCatalogVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "PlProductCatalogVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody PlProductCatalogVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<PlProductCatalogVo>", required = true, dataType = "List<PlProductCatalogVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlProductCatalogVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlProductCatalogVo model) {
