 ...
 */
@RestController
@RequestMapping("/plproductinfoprice/api")
@Api(value = "商品价格查询服务")
public class PlProductInfoPriceController {
	...
	@ApiOperation(value="商品价格查询服务",notes="提供商品价格查询服务，主要包含商品编码、价格1、价格2......等。")
	@ApiImplicitParam(name="productCode",value="入参为商品编码（唯一7位商品编码标识）", required = true, dataType = "String",paramType = "query")
	@RequestMapping(value = "/productPrice_queryService", method=RequestMethod.POST)
	@ResponseBody
	public void productPriceQueryService(@RequestParam String productCode,HttpServletResponse response) throws IOException {
