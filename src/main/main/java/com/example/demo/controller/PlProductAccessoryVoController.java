...
*/
@RestController
@RequestMapping("/plproductaccessoryvo/api")
@Api(value = "xx", description = "xx")
public class PlProductAccessoryVoController {
 
    @Resource
    private PlProductAccessoryVoService services;
    ...
    public List<PlProductAccessoryVo> list(HttpServletRequest request) {

    	Condition condition =new Condition(PlProductAccessoryVo.class);
    	Condition.Criteria criteria = condition.createCriteria();
    	criteria.andCondition(" ID ='' ");
    	List<PlProductAccessoryVo> list =services.selectByCondition(condition);
        return  list;
    }
    @ApiIgnore
    ...
    public Object get_one(String id) {
        PlProductAccessoryVo model = services.selectByPrimaryKey(id);
        return model;
        }
        
 	@ApiIgnore
	@ApiOperation(value="新增实体信息",notes="新增实体信息")
	@ApiImplicitParam(name="model",value="实体值", required = true, dataType = "PlProductAccessoryVo")
    @RequestMapping(value = "/add_one", method=RequestMethod.POST)
    @ResponseBody
    public Object add_one(@RequestBody PlProductAccessoryVo model) {
	...
	@ApiImplicitParam(name="model",value="实体集合List<PlProductAccessoryVo>", required = true, dataType = "List<PlProductAccessoryVo>")
    @RequestMapping(value = "/add_multiple", method=RequestMethod.POST)
    @ResponseBody
    public Object add_multiple(@RequestBody List<PlProductAccessoryVo> model) {
    ...
    @ResponseBody
    public Object edit_one(@RequestBody PlProductAccessoryVo model) {
